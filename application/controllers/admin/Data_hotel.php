...
class Data_hotel extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config['base_url'] = base_url('admin/data_hotel/index');
        ...
        $data['hotel'] = $this->model_hotel->get_hotel_pagination($config['per_page'], $this->uri->segment(4));
    ...
    public function update()
    {
        ...
        if ($gambar_hotel == '') {
            ...
            if ($file_type != 'image/jpeg' && $file_type != 'image/png') {
                ...
                redirect('admin/data_hotel/edit/' . $id);
            }
        ...
        redirect('admin/data_hotel/index');
    }
    ...
    public function detail_hotel($id_hotel)
    {
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/sidebar');
        $this->load->view('admin/detail_hotel', $data);
        $this->load->view('templates_admin/footer');
    }
