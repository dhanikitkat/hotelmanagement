    ...
    <table class="table">
        ...
        foreach ($hotel as $htl) : ?>
            <tr>
                <td><?php echo $no++ ?></td>
                <td>
                    <img src="<?php echo base_url('uploads/' . $htl->gambar_hotel); ?>" alt="Gambar Hotel" width="125">
                </td>
                <td class="text-dark font-weight-bold"><?php echo $htl->nama_hotel ?></td>
                <td class="text-justify"><?php echo $htl->alamat ?></td>
                <td><?php echo $htl->fasilitas ?></td>
                <td style="width: 150px;">Rp. <?php echo number_format($htl->harga_min, 0, ',', '.') ?></td>
                <td style="width: 150px;">Rp. <?php echo number_format($htl->harga_max, 0, ',', '.') ?></td>


                <td><?php echo anchor('admin/data_hotel/detail_hotel/' . $htl->id_hotel, '<div class="btn btn-success btn-sm"><i class="fas fa-search-plus"></i></div>') ?></td>
                <td><?php echo anchor('admin/data_hotel/edit/' . $htl->id_hotel, '<div class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></div>') ?></td>
                <td>
                    <a href="<?php echo base_url('admin/data_hotel/hapus/' . $htl->id_hotel) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin ingin menghapus hotel ini?')">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url() . 'admin/data_hotel/tambah_aksi'; ?>" method="post" enctype="multipart/form-data">
